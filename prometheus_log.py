    ...
    def file_readlines(self, line):
        ...
        if '"message" =>' in line:  # 如果一行中有 message 再打印
            ...
            if (counter % 20 == 0):  # 取模 每出10行 输出一次
                ...
                os.popen(
                    " echo \"http_counter $http_counter\" | curl --data-binary @- http://localhost:9091/metrics/job/pushgateway/instance/localhost:9091")
            ...
            if (counter % 10 == 0):  # 取模 每出10行 输出一次 request
                ...
                os.popen(
                    " echo \"http_request_time $request_time\" | curl --data-binary @- http://localhost:9091/metrics/job/pushgateway/instance/localhost:9091")
            ...
            if (counter % 20 == 0):  # 取模 每出10行 输出一次 http_code
                ...
                os.popen(
                    " echo \"http_code_5xx $http_code_5xx\" | curl --data-binary @- http://localhost:9091/metrics/job/pushgateway/instance/localhost:9091")
                ...
                os.popen(
                    " echo \"http_code_4xx $http_code_4xx\" | curl --data-binary @- http://localhost:9091/metrics/job/pushgateway/instance/localhost:9091")
                ...
                os.popen(
                    " echo \"http_code_3xx $http_code_3xx\" | curl --data-binary @- http://localhost:9091/metrics/job/pushgateway/instance/localhost:9091")
                ...
                os.popen(
                    " echo \"http_code_2xx $http_code_2xx\" | curl --data-binary @- http://localhost:9091/metrics/job/pushgateway/instance/localhost:9091")

    ###############################################################################
    # this is a function similar to tailf -f in order to monitor the latest message from logfile
    def file_readline(self):
        f = os.open(self.logname, 'r')
        f.seek(0, 2)
